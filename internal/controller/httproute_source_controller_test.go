...
// ---- TestHTTPRouteSource_ZoneRefCrossNamespace_PropagatedToEmittedCR -------
// Regression for issue #65: when the CloudflareZone lives in a different
// namespace than the HTTPRoute, the emitted CloudflareDNSRecord (data + TXT)
...
func TestHTTPRouteSource_ZoneRefCrossNamespace_PropagatedToEmittedCR(t *testing.T) {
	s := httpRouteScheme(t)

	// Zone lives in "zones"; route + tunnel live in "apps".
